...
async def background_send_4(user_hash_list, background_tasks) -> JSONResponse:
    for item in user_hash_list:
        message = MessageSchema(
            ...
            body=template5.format(email=[item["email"]], target=[item["target"]], lastname=[item["lastname"]], staff_id=[item["staff_id"]], firstname=[item["firstname"]], resources=[item["resources"]], middlename=[
                                  item["middlename"]], supervisor=[item["supervisor"]], result_areas=[item["result_areas"]], supervisor_email=[item["supervisor_email"]], appraisal_form_id=[item["appraisal_form_id"]]),
            subtype="html"
        )
        background_tasks.add_task(fm.send_message, message)
...
async def background_send_35(user_hash_list, background_tasks) -> JSONResponse:
    for item in user_hash_list:
        message = MessageSchema(
            ...
            recipients=[item[0]],
            body=template19.format(target=[item[1]], resources=[
                                   item[2]], result_areas=[item[3]]),
            subtype="html"
        )
        background_tasks.add_task(fm.send_message, message)
...
async def background_send_40(user_hash_list, background_tasks) -> JSONResponse:
    for item in user_hash_list:
        message = MessageSchema(
            subject="Appraisal Form Details",
            recipients=[item["email"]],
            body=template26.format(email=[item["email"]], target=[item["target"]], lastname=[item["lastname"]], staff_id=[item["staff_id"]], firstname=[item["firstname"]], resources=[item["resources"]], middlename=[
                                   item["middlename"]], supervisor=[item["supervisor"]], result_areas=[item["result_areas"]], supervisor_email=[item["supervisor_email"]], appraisal_form_id=[item["appraisal_form_id"]]),
            subtype="html"
        )
        background_tasks.add_task(fm.send_message, message)
...
async def background_send_13(user_hash_list) -> JSONResponse:
    for item in user_hash_list:
        message = MessageSchema(
            ...
            recipients=[item["supervisor_email"]],
            body=template5.format(email=[item["email"]], target=[item["target"]], lastname=[item["lastname"]], staff_id=[item["staff_id"]], firstname=[item["firstname"]],  resources=[
                                  item["resources"]], middlename=[item["middlename"]], result_areas=[item["result_areas"]], supervisor_email=[item["supervisor_email"]], appraisal_form_id=[item["appraisal_form_id"]]),
            subtype="html"
        )
        background_tasks.add_task(fm.send_message, message)
...
async def background_send_18(user_hash_list) -> JSONResponse:
    for item in user_hash_list:
        message = MessageSchema(
            ...
            recipients=[item[9]],
            body=template17.format(email=[item[0]], target=[item[1]], lastname=[item[2]], staff_id=[item[3]], firstname=[item[4]], resources=[
                                   item[5]], middlename=[item[6]], result_areas=[item[7]], appraisal_form_id=[item[8]], supervisor_email=[item[9]]),
            subtype="html"
        )
        await fm.send_message(message)
...
async def background_send_19(user_hash_list) -> JSONResponse:
    for item in user_hash_list:
        message = MessageSchema(
            ...
            recipients=[item[0]],
            body=template18.format(email=[item[0]], target=[item[1]], lastname=[item[2]], staff_id=[item[3]], firstname=[item[4]], resources=[
                                   item[5]], middlename=[item[6]], result_areas=[item[7]], appraisal_form_id=[item[8]], supervisor_email=[item[9]]),
            subtype="html"
        )
        await fm.send_message(message)
...
async def background_send_27(user_hash_list) -> JSONResponse:
    for item in user_hash_list:
        message = MessageSchema(
            ...
            recipients=[item["supervisor_email"]],
            body=template25.format(frontend_url=settings.FRONTEND_URI, email=[item["email"]], progress_review=[item["progress_review"]], lastname=[item["lastname"]], staff_id=[item["staff_id"]], firstname=[item["firstname"]], remarks=[item["remarks"]], middlename=[item["middlename"]], competency=[item["competency"]], supervisor_email=[item["supervisor_email"]], appraisal_form_id=[item["appraisal_form_id"]], frontend_url=settings.FRONTEND_URI), subtype="html"
        )
        background_tasks.add_task(fm.send_message, message)
...
async def background_send_28(user_hash_list) -> JSONResponse:
    for item in user_hash_list:
        message = MessageSchema(
            ...
            recipients=[item["supervisor_email"]],
            body=template25.format(frontend_url=settings.FRONTEND_URI, email=[item["email"]], progress_review=[item["progress_review"]], lastname=[item["lastname"]], staff_id=[item["staff_id"]], firstname=[item["firstname"]], remarks=[
...
async def background_send_33(user_hash_list) -> JSONResponse:
    for item in user_hash_list:
        message = MessageSchema(
            ...
            recipients=[item[0]],
            body=template20.format(email=[item[0]], target=[item[1]], lastname=[item[2]], staff_id=[item[3]], firstname=[item[4]], resources=[item[5]], middlename=[
                                   item[6]], result_areas=[item[7]], appraisal_form_id=[item[8]], supervisor_email=[item[9]], annual_plan_comment=[item[10]], frontend_url=settings.FRONTEND_URI),
            subtype="html"
        )
        await fm.send_message(message)
...
async def background_send_38(user_hash_list) -> JSONResponse:
    for item in user_hash_list:
        message = MessageSchema(
            subject="Form Disaproved",
            recipients=[item[0]],
            body=template22.format(email=[item[0]], progress_review=[item[1]], lastname=[item[2]], staff_id=[item[3]], firstname=[item[4]], remarks=[item[5]], middlename=[
                                   item[6]], competency=[item[7]], appraisal_form_id=[item[8]], supervisor_email=[item[9]], midyear_review_comment=[item[10]], frontend_url=settings.FRONTEND_URI),
            subtype="html"
        )
        await fm.send_message(message)
    ...
    for item in user_hash_list:
        message = MessageSchema(
            ...
            body=template21.format(email=[item[0]], progress_review=[item[1]], lastname=[item[2]], staff_id=[item[3]], firstname=[item[4]], remarks=[
                                   item[5]], middlename=[item[6]], competency=[item[7]], appraisal_form_id=[item[8]], supervisor_email=[item[9]], frontend_url=settings.FRONTEND_URI),
            subtype="html"
        )
        await fm.send_message(message)
