...
from app.static.email_templates.template_29 import template29
from app.static.email_templates.template_30 import template30
from app.static.email_templates.template_31 import template31
from app.static.email_templates.template_32 import template32
from app.static.email_templates.template_33 import template33
from app.static.email_templates.template_34 import template34
from app.static.email_templates.template_35 import template35
from app.static.email_templates.template_36 import template36
from app.static.email_templates.template_37 import template37
from app.static.email_templates.template_38 import template38
from app.static.email_templates.template_39 import template39
from app.static.email_templates.template_40 import template40
from app.static.email_templates.template_41 import template41
from app.static.email_templates.template_42 import template42
from app.static.email_templates.template_43 import template43
from app.static.email_templates.template_44 import template44
from app.static.email_templates.template_45 import template45
from app.static.email_templates.template_46 import template46
from app.static.email_templates.template_47 import template47
...
async def background_send_2(user_hash_list, background_tasks) -> JSONResponse:
    for item in user_hash_list:
        message = MessageSchema(
            ...
            recipients=[item[1]],
            body=template3.format(
                url=settings.END_URL, hash=item[0], firstname=item[2], middlename=item[3], lastname=item[4]),
            subtype="html"
        )
