...
# IMPORT MODELS
from app.routers.auth_router import models
...
# from app.routers.email import main as email
...
api.include_router(phase4.router, prefix="/api/finalremarks", tags=["Final Remarks"])
