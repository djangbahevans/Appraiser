...
<html xmlns="http://www.w3.org/1999/xhtml" lang="en-GB">
  ...
  <body style="margin: 0px; padding: 20px; background-color: #f1f2f6">
    ...
    <h1 style="font-size: 14px; color: red">
      Developers <span style="font-size: 10px">&#128297;</span
      ><span style="font-size: 10px">&#9935;</span>
    </h1>
    <ul>
      <li style="font-size: 12px">Sel</li>
      <li style="font-size: 12px">Emma</li>
      <li style="font-size: 12px">Iwan</li>
    </ul>
